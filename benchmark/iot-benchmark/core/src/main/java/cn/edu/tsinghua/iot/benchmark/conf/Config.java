...
public class Config {
  ...
  private double QUERY_EXPRESSION_VALUE = 20;
  ...
  public double getQUERY_EXPRESSION_VALUE() {
    return QUERY_EXPRESSION_VALUE;
  }

  public void setQUERY_EXPRESSION_VALUE(double QUERY_EXPRESSION_VALUE) {
    this.QUERY_EXPRESSION_VALUE = QUERY_EXPRESSION_VALUE;
  }
  ...
  public ConfigProperties getAllConfigProperties() {
    ...
    if (hasQuery()) {
      ...
      configProperties.addProperty("Extern Param", "QUERY_EXPRESSION", this.QUERY_EXPRESSION);
      configProperties.addProperty("Extern Param", "QUERY_LOWER_VALUE", this.QUERY_LOWER_VALUE);
      configProperties.addProperty(
          "Extern Param", "QUERY_EXPRESSION_VALUE", this.QUERY_EXPRESSION_VALUE);
