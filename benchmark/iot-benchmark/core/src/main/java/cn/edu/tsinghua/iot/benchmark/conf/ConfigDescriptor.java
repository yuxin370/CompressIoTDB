  ...
  private void loadProps() {
    ...
    if (url != null) {
      ...
      try {
        ...
        config.setQUERY_EXPRESSION(
            properties.getProperty("QUERY_EXPRESSION", config.getQUERY_EXPRESSION()));
        ...
        config.setQUERY_EXPRESSION_VALUE(
            Double.parseDouble(
                properties.getProperty(
                    "QUERY_EXPRESSION_VALUE", config.getQUERY_EXPRESSION_VALUE() + "")));
